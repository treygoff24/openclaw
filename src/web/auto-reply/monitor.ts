  ...
  const cfg = {
    ...
    channels: {
      ...
      whatsapp: {
        ...
        ackReaction: account.ackReaction ?? baseCfg.channels?.whatsapp?.ackReaction,
        messagePrefix: account.messagePrefix ?? baseCfg.channels?.whatsapp?.messagePrefix,
        allowFrom: account.allowFrom ?? baseCfg.channels?.whatsapp?.allowFrom,
        groupAllowFrom: account.groupAllowFrom ?? baseCfg.channels?.whatsapp?.groupAllowFrom,
        groupPolicy: account.groupPolicy ?? baseCfg.channels?.whatsapp?.groupPolicy,
        textChunkLimit: account.textChunkLimit ?? baseCfg.channels?.whatsapp?.textChunkLimit,
        chunkMode: account.chunkMode ?? baseCfg.channels?.whatsapp?.chunkMode,
        mediaMaxMb: account.mediaMaxMb ?? baseCfg.channels?.whatsapp?.mediaMaxMb,
        blockStreaming: account.blockStreaming ?? baseCfg.channels?.whatsapp?.blockStreaming,
        groups: account.groups ?? baseCfg.channels?.whatsapp?.groups,
      },
    },
