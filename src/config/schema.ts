...
const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.toolDisclosure": "Tool Disclosure",
  "agents.defaults.toolDisclosure.mode": "Tool Disclosure Mode",
  "agents.defaults.toolDisclosure.alwaysAllow": "Tool Disclosure Always Allow",
  "agents.defaults.toolDisclosure.maxActiveTools": "Tool Disclosure Max Active Tools",
  "agents.defaults.toolDisclosure.minConfidence": "Tool Disclosure Min Confidence",
  "agents.defaults.toolDisclosure.lowConfidenceFallback": "Tool Disclosure Low-Confidence Fallback",
  "agents.defaults.toolDisclosure.includeCategorySummary": "Tool Disclosure Category Summary",
  "agents.defaults.toolDisclosure.stickyTurns": "Tool Disclosure Sticky Turns",
  "agents.defaults.toolDisclosure.stickyMaxTools": "Tool Disclosure Sticky Max Tools",
  "agents.list[].toolDisclosure": "Agent Tool Disclosure",
  "agents.list[].toolDisclosure.mode": "Agent Tool Disclosure Mode",
  "agents.list[].toolDisclosure.alwaysAllow": "Agent Tool Disclosure Always Allow",
  "agents.list[].toolDisclosure.maxActiveTools": "Agent Tool Disclosure Max Active Tools",
  "agents.list[].toolDisclosure.minConfidence": "Agent Tool Disclosure Min Confidence",
  "agents.list[].toolDisclosure.lowConfidenceFallback":
    "Agent Tool Disclosure Low-Confidence Fallback",
  "agents.list[].toolDisclosure.includeCategorySummary": "Agent Tool Disclosure Category Summary",
  "agents.list[].toolDisclosure.stickyTurns": "Agent Tool Disclosure Sticky Turns",
  "agents.list[].toolDisclosure.stickyMaxTools": "Agent Tool Disclosure Sticky Max Tools",
